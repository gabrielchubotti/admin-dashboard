(function (global, factory) {
  ...
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/tooltip', 'prop-types', 'lodash/merge', 'lodash/get', 'lodash/set', 'lodash/last', 'lodash/isArray', 'lodash/isString', 'd3-scale', 'd3-scale-chromatic', 'lodash/isFunction', 'lodash/without', 'd3-shape', 'd3-hierarchy', 'd3-format', 'd3-time-format', 'lodash', 'react-spring', 'recompose/withProps', 'lodash/isEqual', 'recompose/compose', 'recompose/setPropTypes', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'lodash/isPlainObject', 'lodash/pick'], factory) :
...
}(this, (function (exports, React, tooltip, PropTypes, merge, get, set, last, isArray, isString, d3Scale, d3ScaleChromatic, isFunction, without, d3Shape, d3Hierarchy, d3Format, d3TimeFormat, lodash, reactSpring, withProps, isEqual, compose, setPropTypes, defaultProps, withPropsOnChange, isPlainObject, pick) { 'use strict';
