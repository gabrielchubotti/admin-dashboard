(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/tooltip'), require('prop-types'), require('@nivo/colors'), require('lodash'), require('d3-format'), require('d3-geo'), require('@nivo/legends')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/tooltip', 'prop-types', '@nivo/colors', 'lodash', 'd3-format', 'd3-geo', '@nivo/legends'], factory) :
...
}(this, (function (exports, React, core, tooltip, PropTypes, colors, lodash, d3Format, d3Geo, legends) { 'use strict';
